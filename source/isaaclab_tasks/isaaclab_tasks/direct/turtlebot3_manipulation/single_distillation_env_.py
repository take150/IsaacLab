...
class EventCfg:
    ...
    # rrandomize_joints_gain_1 = EventTerm(
    ...
    #         "stiffness_distribution_params": (600, 600),
    #         "damping_distribution_params": (60, 80),
    #         "operation": "abs",
    #         "distribution": "uniform",
    #     },
    # )
...
@configclass
class Turtlebot3SingleDistillationEnvCfg(DirectRLEnvCfg):
    # env
    ...
    observation_space = {"joint": [5, 6], "object": [5, 14], "actions": [5, 7], "rgb": [camera.height, camera.width, 3]}
...
class Turtlebot3SingleDistillationEnv(DirectRLEnv):
    ...
    cfg: Turtlebot3SingleDistillationEnvCfg

    def __init__(self, cfg: Turtlebot3SingleDistillationEnvCfg, render_mode: str | None = None, **kwargs):
    ...
    def _pre_physics_step(self, actions: torch.Tensor):
        ...
        # |a| < deadband は0、それ以外は (|a|-deadband)/(1-deadband) に圧縮
        deadband = 0.4

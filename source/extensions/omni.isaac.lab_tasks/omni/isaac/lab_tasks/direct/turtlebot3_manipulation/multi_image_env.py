...
class Turtlebot3MultiImageEnvCfg(DirectMARLEnvCfg):
    ...
    observation_spaces = {
        "robot_1": [camera_1.height, camera_1.width, 3], "robot_2": [camera_2.height, camera_2.width, 3]
    }
    state_space = -1
...
class Turtlebot3MultiImageEnv(DirectMARLEnv):
    ...
    def _reset_idx(self, env_ids: torch.Tensor | None):
        ...
        self._robot_2.write_joint_state_to_sim(joint_pos_1, joint_vel_1, env_ids=env_ids)
        ...
        default_cube_state_1[:, :3] += self.reset_root_state_uniform(
            env_ids=env_ids,
            pose_range = {"x": (0.1, 0.5), "y": (0.4, 0.6), "z": (0.0, 0.0)},
        )
        ...
        default_cube_state_2[:, :3] += self.reset_root_state_uniform(
            env_ids=env_ids,
            pose_range = {"x": (0.1, 0.5), "y": (-0.6, -0.4), "z": (0.0, 0.0)},
        )
    ...
    def _get_observations(self) -> dict:
        ...
        camera_data_1 = self._camera_1.data.output["rgb"] / 255.0
        camera_data_2 = self._camera_2.data.output["rgb"] / 255.0
    ...
    def _compute_rewards(
        ...
        rewards = {
            "robot_1": dist_reward_scale * dis_reward_1 + + lift_reward_scale * lift_reward_1,
            "robot_2": dist_reward_scale * dis_reward_2 + + lift_reward_scale * lift_reward_2
        }
